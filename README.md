...
# 📖 "To-do List with webpack Project for testing!" <a name="about-project"></a>
...
In this project, testing and reviews are conducted by coding partners in order to follow coding best practice standard.
